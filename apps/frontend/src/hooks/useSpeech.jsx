...
const backendUrl = "   https://avatar-backend-691156478708.us-central1.run.app" // This is the correct URL for your backend
...
export const SpeechProvider = ({ children }) => {
  ...
  // This useEffect was previously misplaced, causing the build error.
  // It is now correctly placed as a separate hook.
  useEffect(() => {
  ...
  }, []) // Correct closing for this useEffect
